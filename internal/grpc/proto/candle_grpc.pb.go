...
type CandleServiceClient interface {
	SubscribeCandles(ctx context.Context, in *CandleRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Candle], error)
}
...
func (c *candleServiceClient) SubscribeCandles(ctx context.Context, in *CandleRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Candle], error) {
...
type CandleServiceServer interface {
	SubscribeCandles(*CandleRequest, grpc.ServerStreamingServer[Candle]) error
...
func (UnimplementedCandleServiceServer) SubscribeCandles(*CandleRequest, grpc.ServerStreamingServer[Candle]) error {
...
func _CandleService_SubscribeCandles_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(CandleServiceServer).SubscribeCandles(m, &grpc.GenericServerStream[CandleRequest, Candle]{ServerStream: stream})
}
